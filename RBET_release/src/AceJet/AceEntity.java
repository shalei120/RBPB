...
/**
 * an Ace Entity, with information from the ACE key. The 'id' field is inherited
 * from its superclass, AceEventArgumentValue.
 */
public class AceEntity extends AceEventArgumentValue {

    /**
     * the EDT type of the entity: PERSON, ORGANIZATION, GPE, LOCATION, or
     * FACILITY; for ACE 2004, also WEAPON or VEHICLE.
     */
    public String type;
    /**
