...
/**
 * the value of an AceEventMention argument: an AceEntityMention, an
 * AceTimexMention, an AceValueMention, or an AceEventAnchor.
 */
public abstract class AceMention implements Comparable {

    public String id;
    /**
     * the extent of the mention, with start and end positions based on ACE
     * offsets (excluding XML tags).
     */
    public Span extent;
    /**
     * the extent of the mention, with start and end positions based on Jet
     * offsets (including all following whitespace).
     */
    public Span jetExtent;
    /**
     * the text of the extent.
     */
    public String text,isArg;
     ...
     * start of the head of 'o' follows, is the same as, or precedes the head of
     * this AceMention.
     */
    public int compareTo(Object o) {
        if (!(o instanceof AceMention)) {
    ...
    private int typeCode(AceMention o) {
        if (o instanceof AceValueMention) {
            return 3;
        }
