...
public class AceEventMentionArgument {
	 ...
	 *  the role of the argument in the event
         *  data is added by Lei Sha
	 */
	public String role,data;
	/**
	...
	public AceEventMentionArgument (AceMention value, String role) {
        ...
        public AceEventMentionArgument (String value, String role) {
		this.data = value;
		this.role = role;
	}
...
//		}
                w.println("      <extent>");
                w.println("             <charseq END=\""+value.extent.end()+ "\" START=\""+value.extent.start()+ "\">"+value.text+"</charseq>");
		//AceMention.writeCharseq (w, extent, text);
		w.println("      </extent>");
