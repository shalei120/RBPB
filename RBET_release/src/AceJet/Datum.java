...
/**
 * a data point, consisting of a set of features and an outcome, intended as
 * part of the training set for a classifier.
 */
public class Datum {
    ...
    public Datum(String s) {
        ...
        this.outcome = split[split.length - 1];
        for (int i = 0; i < split.length - 1; i++) {
            this.features.add(split[i]);
        }
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < features.size(); i++) {
            if ("".equals((String) features.get(i))) {
                continue;
            }
